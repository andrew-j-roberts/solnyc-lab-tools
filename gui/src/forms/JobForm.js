...
export default function JobForm() {
  ...
  switch (type) {
    case "sdkperf_c":
      ...
      break;
    case "sdkperf_java":
      form = <SdkperfJavaForm />;
      break;
    case "sdkperf_jms":
      form = <SdkperfJmsForm />;
      break;
    case "sdkperf_mqtt":
      form = <SdkperfMqttForm />;
      break;
    case "sdkperf_rest":
      form = <SdkperfRestForm />;
      break;
  }
  return (
    <>
...
function CommandStringPreview({ command, values }) {
  ...
  return (
    <Stack isInline bg="gray.800" height="66px" alignItems="center" spacing={2}>
      <Button onClick={onCopy} ml={2} position="absolute" left="90%">
        {hasCopied ? "Copied" : "Copy"}
      </Button>
      <Text color="gray.50" fontSize={"l"} fontFamily="mono">
        ▶
      </Text>
      <Text color="green.400" fontSize={"l"} fontFamily="mono">
        {command}
      </Text>
      <Text color="gray.50" fontSize={"l"} fontFamily="mono">
        {options}
      ...
      >
        {({ handleSubmit, isSubmitting, values }) => (
          <Form onSubmit={handleSubmit}>
            <CommandStringPreview command={"sdkperf_c"} values={values} />
